class Heyho
 ...
 def do
  cookies = ["“Welcome” is a powerful word.",
    ...
    "When you are on this keep your head straight and robust",
    "Players love to give you that blah blah, don't you let them eat that that crap crap",
    "Creating the rules don't rely on manuals",
    "Live with heart of steel prep for anything unusual",
    "Money flow is the star of attention but shining too much is the cause of tension",
    "Watch what you mention",
    "Watch what you mention",
    "Haters search mistakes with mal intention",
    "Don't let some info screw your thoughts",
    "Look for mentors scribble down notes in you soul",
    "Rather have slices instead of the whole pie 'cause greed ain't discreet",
    ...
    puts cookie.to_s
    #File.open('somefile.txt', 'w') { |file| file.write(cookie) }
 end
end
